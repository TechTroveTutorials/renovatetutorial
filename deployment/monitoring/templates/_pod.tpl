...
*/}}
{{- define "monitoring.pod.env" -}}
{{- $resourceAttributesEnv := dict }}
{{- $allEnvs := list }}
{{- if .useDefault.env  }}
{{-   $defaultEnvs := include "monitoring.envOverriden" (dict "env" .defaultValues.env "envOverrides" .defaultValues.envOverrides) | mustFromJson }}
{{-   range $defaultEnvs }}
...
{{-   $allEnvs = concat $allEnvs ((include "monitoring.envOverriden" .) | mustFromJson) }}
{{- end }}
